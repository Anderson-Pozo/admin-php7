        ...
        <div class="card border border-danger">
                ...
                <form method="post">
                    <div class="form-group">
                        <strong class="card-title">
                            ¿Está seguro que desea eliminar toda la información de <?php echo $response['nom_estable'] ?> ?
                        </strong>
                    </div>
                    <button class="btn btn-danger" name="eliminar" id="eliminar" type="submit">
                        Eliminar
                    </button>
                    <button class="btn btn-primary" onclick="history.go(-1);" type="button">
                        Cancelar
                    </button>
                </form>
            </div>
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <label><?php echo $response['nom_estable'] ?></label>
                </div>
                <div class="form-group">
                    <strong class="">Dirección: </strong>
                    <label><?php echo $response['direccion'] ?></label>
                </div>
                <div class="form-group">
