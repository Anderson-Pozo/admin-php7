                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="lat" name="lat" type="number" class="form-control" step="any" value="<?php echo $response['lat'] ?>">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label class="control-label mb-1">Longitud</label>
                                <input id="lng" name="lng" type="number" class="form-control" step="any" value="<?php echo $response['lng'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
